            ...
            {user ? (
              <form onSubmit={sendMessage} className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-100 dark:bg-slate-800 border-none rounded-full px-4 py-2 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                />
                <button
                  type="submit"
